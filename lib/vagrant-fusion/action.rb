...
module VagrantPlugins
  module Fusion
    module Action
      ...
      def self.action_package
        Vagrant::Action::Builder.new.tap do |b|
          b.use Call, IsCreated do |env, b2|
            ...
            # Connect to Fusion and then Create a package from the server instance
            b2.use ConnectFusion
      ...
      autoload :ConnectFusion, action_root.join("connect_fusion")
